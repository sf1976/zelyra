...
destruktive Änderungen ohne `--allow-destructive` abgelehnt wurden. `setup`,
`bootstrap`, `inspect` und `apply` benötigen `DATABASE_URL`; `plan` kann ohne
Variable auch gegen eine leere Datenbank planen.
