...
Als Nächstes folgen konfigurierbare Spalten, Sortierung, Filter, Detailseiten
sowie Formulare für Erstellen, Ändern und Löschen. Das vollständige Beispiel
mit Beziehung ist `examples/machine_form.zyl`.
