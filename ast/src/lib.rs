...
#[derive(Clone, Debug, PartialEq, Eq)]
pub struct CrudFormViewDef {
    pub mode: CrudFormViewMode,
    pub title: Option<String>,
    pub submit: Option<String>,
}

impl Default for CrudFormViewDef {
    fn default() -> Self {
        Self {
            mode: CrudFormViewMode::Standard,
            title: None,
            submit: None,
        }
    }
