...
const DEFAULT_MARIADB_ENV_TEMPLATE: &str = r#"# Generated by `zelyra setup`. Never commit .env or real credentials.
ZELYRA_WEB_PORT=3000
ZELYRA_HOST_PORT=3000
ZELYRA_DB_HOST_PORT=3306
...
fn setup_project(path: &str) -> ExitCode {
    ...
    let template = if example_file.is_file() {
        ...
        DEFAULT_MARIADB_ENV_TEMPLATE.to_owned()
    };
